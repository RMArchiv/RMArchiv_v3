        ...
        <div class="flex w-1/2 pl-4 text-sm">
            <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                <li class="mr-2 hover:bg-rm-blue">
                    <a class="inline-block py-2 px-2 text-rm-href no-underline hover:text-rm-href-hover" href="/">{{ __('topnav.home') }}</a>
                </li>
                <li class="mr-2 hover:bg-rm-blue">
                    <a class="inline-block text-rm-href no-underline hover:text-rm-href-hover py-2 px-2" href="/">{{ __('topnav.games') }}</a>
                </li>
                <li class="mr-2 hover:bg-rm-blue">
                    <a class="inline-block text-rm-href no-underline hover:text-rm-href-hover py-2 px-2" href="/">{{ __('topnav.developers') }}</a>
                </li>
                <li class="mr-2 hover:bg-rm-blue">
                    <a class="inline-block text-rm-href no-underline hover:text-rm-href-hover py-2 px-2" href="/">{{ __('topnav.resources') }}</a>
                </li>
            </ul>
        </div>
